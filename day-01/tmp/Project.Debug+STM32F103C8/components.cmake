...
add_library(Keil_Device_Startup_1_0_0 OBJECT
  "${SOLUTION_ROOT}/Project/RTE/Device/STM32F103C8/startup_stm32f10x_md.s"
  "${SOLUTION_ROOT}/Project/RTE/Device/STM32F103C8/system_stm32f10x.c"
)
target_include_directories(Keil_Device_Startup_1_0_0 PUBLIC
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_INCLUDE_DIRECTORIES>
  "${SOLUTION_ROOT}/Project/RTE/Device/STM32F103C8"
...
cbuild_set_defines(AS_ARM COMPILE_DEFINITIONS)
set_source_files_properties("${SOLUTION_ROOT}/Project/RTE/Device/STM32F103C8/startup_stm32f10x_md.s" PROPERTIES
  COMPILE_FLAGS "${COMPILE_DEFINITIONS}"
)
...
add_library(Keil_Device_StdPeriph_Drivers_Framework_3_6_0 OBJECT
  "${SOLUTION_ROOT}/Project/RTE/Device/STM32F103C8/stm32f10x_conf.h"
